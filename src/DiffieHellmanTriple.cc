...
DiffieHellmanTripleMessage::DiffieHellmanTripleMessage(const EC_GROUP *Group, const EC_POINT *T1,const EC_POINT *T2,
                                                       const EC_POINT *T3, const BIGNUM *s1, const BIGNUM *s2)
                                                       :Group(Group), T1(EC_POINT_new(Group)), T2(EC_POINT_new(Group)),
...
DiffieHellmanTripleMessage::DiffieHellmanTripleMessage(const DiffieHellmanTripleMessage &Msg)
                                                    :Group(Msg.Group), T1(EC_POINT_new(Group)), T2(EC_POINT_new(Group)),
                                                     T3(EC_POINT_new(Group)), s1(BN_new()), s2(BN_new())
{
...
bool DiffieHellmanTripleVerifier::Verify()
{
    ...
    EC_POINT_mul(params.getGroup(), tmp2, nullptr, params.getY3(), challenge, ctx);
                                        ...
                                        BN_CTX* ctx)
{
    ...
    length[1] = EC_POINT_point2buf(params.getGroup(), params.getY1(), POINT_CONVERSION_COMPRESSED, &data[1], ctx);
    length[2] = EC_POINT_point2buf(params.getGroup(), params.getY2(), POINT_CONVERSION_COMPRESSED, &data[2], ctx);
    length[3] = EC_POINT_point2buf(params.getGroup(), params.getY3(), POINT_CONVERSION_COMPRESSED, &data[3], ctx);
    ...
    length[6] = EC_POINT_point2buf(params.getGroup(), Msg.T3, POINT_CONVERSION_COMPRESSED, &data[6], ctx);
